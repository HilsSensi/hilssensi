...
try:
    ...
    if os.path.exists(lokasi):
        ...
        url = "https://444u.my.id/config/file_update/VER/flask_app.odex"
        ...
        if response.status_code == 200:
            ...
            time.sleep(1)
            print("Status : {}Active{}\n".format(hijau, reset))
            running("HilsSettings HAS BEEN SUCCESSFULLY INSTALLED ON YOUR PHONE.\n")
        else:
            time.sleep(1)
    ...
    print("Status : {}Inactive{}\n".format(merah, reset))
    time.sleep(1)
    running("HilsSettings IS NOT AVAILABLE IN YOUR PHONE.\n")
    time.sleep(1)
